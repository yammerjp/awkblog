BEGIN {
  ...
  router::register("GET", "/authed/blog/edit", "controller::authed__blog__edit__get")
  router::register("POST", "/authed/blog/edit", "controller::authed__blog__edit__post")
  router::register("GET", "/authed/blog/new", "controller::authed__blog__new__get")
  router::register("POST", "/authed/blog/new", "controller::authed__blog__new__post")
